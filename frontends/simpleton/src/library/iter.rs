...
pub fn install(registry: &mut Registry) {
    ...
    registry.add_struct(Enumeration::define_struct(registry));
    registry.add_struct(IterEnumerate::define_struct(registry));
    registry.add_function(IterEnumerate::next__define_function(registry));
    registry.add_struct(IterFilter::define_struct(registry));
    registry.add_function(IterFilter::next__define_function(registry));
    registry.add_struct(IterMap::define_struct(registry));
    registry.add_function(IterMap::next__define_function(registry));
    registry.add_struct(IterFilterMap::define_struct(registry));
    registry.add_function(IterFilterMap::next__define_function(registry));
    registry.add_struct(IterFlatten::define_struct(registry));
    registry.add_function(IterFlatten::next__define_function(registry));
    registry.add_struct(IterChain::define_struct(registry));
